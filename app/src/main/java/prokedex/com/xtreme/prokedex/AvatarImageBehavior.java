...
//Thanks to Saúl Molinero for this behavior
...
//Thanks to Hồng Thái for Behavior
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        ...
        if(mStartYPosition - distanceYToSubtract > 36){
            child.setY(mStartYPosition - distanceYToSubtract);
        } else {
            child.setY(36);
        }
        child.setX(mStartXPosition - distanceXToSubtract);
        Log.d(TAG, "onDependentViewChanged: " + (mStartYPosition - distanceYToSubtract));
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + 2*(finalHeight);
