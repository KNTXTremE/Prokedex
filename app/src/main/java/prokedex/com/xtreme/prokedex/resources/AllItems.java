...
public class AllItems {
    ...
    private static String[] pokemonNameJaps = {"フシギダネ - Fushigidane", "フシギソウ - Fushigisou",
            "フシギバナ - Fushigibana", "ヒトカゲ - Hitokage",
            "リザード - Lizardo", "リザードン - Lizardon",
            "ゼニガメ - Zenigame", "カメール - Kameil",
            "カメックス - Kamex", "キャタピー  - Caterpie",
            "トランセル - Trancell", "バタフリー - Butterfree",
            "ビードル - Beedle", "コクーン - Cocoon",
            "スピアー - Spear", "ポッポ - Poppo",
            "ピジョン - Pigeon", "ピジョット - Pigeot",
            "コラッタ - Koratta ", "ラッタ - Ratta",
            "オニスズメ - Onisuzume", "オニドリル - Onidrill",
            "アーボ - Arbo", "アーボック - Arbok",
            "ピカチュウ - Pikachu", "ライチュウ - Raichu",
            "サンド - Sand", "サンドパン - Sandpan",
            "ニドラン♀ - Nidoran♀", "ニドリーナ - Nidorina",
            "ニドクイン - Nidoqueen", "ニドラン♂ - Nidoran♂",
            "ニドリーノ - Nidorino", "ニドキング - Nidoking",
            "ピッピ - Pippi", "ピクシー - Pixy",
            "ロコン - Rokon", "キュウコン - Kyukon",
            "プリン - Purin", "プクリン - Pukurin",
            "ズバット - Zubat", "ゴルバット - Golbat",
            "ナゾノクサ - Nazonokusa", "クサイハナ - Kusaihana",
            "ラフレシア - Ruffresia", "パラス - Paras",
            "パラセクト - Parasect", "コンパン - Kongpang",
            "モルフォン - Morphon", "ディグダ - Digda",
            "ダグトリオ - Dugtrio", "ニャース - Nyarth",
            "ペルシアン - Persian", "コダック - Koduck",
            "ゴルダック - Golduck", "マンキー - Mankey",
            "オコリザル - Okorizaru", "ガーディ - Gardie",
            "ウインディ - Windie", "ニョロモ - Nyoromo"};
